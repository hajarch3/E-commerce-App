...
public class MusiqueFragment extends Fragment {
    private static final String TAG = "MusiqueFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_musique, container, false);
        recyclerView = view.findViewById(R.id.recylerview_music);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (querySnapshot != null) {
                            for (QueryDocumentSnapshot document : querySnapshot) {
                                ...
                                if ("musique".equals(produit.getType())) {
