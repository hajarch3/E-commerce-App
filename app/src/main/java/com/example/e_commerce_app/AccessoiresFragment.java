...
public class AccessoiresFragment extends Fragment {

    private static final String TAG = "AccesoiresFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_accessoires, container, false);
        recyclerView = view.findViewById(R.id.recylerview_access);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (querySnapshot != null) {
                            for (QueryDocumentSnapshot document : querySnapshot) {
                                ...
                                if ("accessoire".equals(produit.getType())) {
