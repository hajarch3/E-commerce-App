...
public class MeubleFragment extends Fragment {
    ...
    private static final String TAG = "MeubleFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_meuble, container, false);
        recyclerView = view.findViewById(R.id.recylerview_meuble);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (querySnapshot != null) {
                            for (QueryDocumentSnapshot document : querySnapshot) {
                                ...
                                if ("meuble".equals(produit.getType())) {
